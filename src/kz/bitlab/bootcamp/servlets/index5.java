...
@WebServlet(value = "/index5")

public class index5 extends HttpServlet {
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        String name = request.getParameter("name_5");
        int age = Integer.parseInt(request.getParameter("age_5"));
        String gender = request.getParameter("radio_5");

        String outStr = "Hello " + ((age >= 18) ? "Dear ":"Dude ") + (
                (gender.equals("male")) ? "Mister " : "Miss ") + name;
