...
@WebServlet(value = "/index4")

public class index4 extends HttpServlet {
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        String name = request.getParameter("name_4");
        String surname = request.getParameter("surname_4");
        String food = request.getParameter("select_4");
